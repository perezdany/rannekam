                ...
                <table class="table table-bordered" id="" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    @php
                      ...
                      {
                        $timestampd1 = strtotime($voir->dat_reserv);//recuperation du timestanp de la date donnée
                        $new_format1 = date("d/m/Y", $timestampd1);//changement du format

                        $timestampd2 = strtotime($voir->dat_emi);//recuperation du timestanp de la date d'emission de la facture donnée
